...
public class TestService {
	...
	/*
	 * @Autowired private RestTemplateUtility restUtil;
	 */
	...
	public String performOcrRequest(Integer clientId, Integer projectId, String filePath, String licenseToken, String ocrEngineName) {
		 ...
		 */
		/*
		 * ResponseEntity<Object> response2 = customRestTemplate.exchange(uri,
	...
	/*
	 * public ServiceBusReceiverClient getServiceBusReceiverClient() throws
	 * Exception {
	 * System.out.println("Creating ServiceBusReceiverClient for queue "+System.
	 * currentTimeMillis()); ServiceBusReceiverClient client = null; synchronized
	 * (this) { System.out.println("Inside thread : "+System.currentTimeMillis());
	 * Thread.sleep(5000); } return client; }
	 */
